...
if("FALSE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/dtrobot/car/src/test)
  set(test_DEVEL_PREFIX /home/dtrobot/car/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/dtrobot/car/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'dtrobot <dtrobot@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dtrobot/car/install/${idir}'.  Ask the maintainer 'dtrobot <dtrobot@todo.todo>' to fix it.")
    endif()
